# 00: Default mapping (CH1/ETR/PD4, CH2/PD3,CH3/PC0, CH4/PD7).encoder mode 2, input on pd4 ch1 and PD3 channel2, works fine,display decimal
...
timer2_pwmin_config:
	...
	ori x11,x11,(2<<0)		# Set the SMS to encoder mode 2,0b010 where the core counter increments or decrements the count at the edge of CH2
