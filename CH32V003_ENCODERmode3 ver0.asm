# 00: Default mapping (CH1/ETR/PD4, CH2/PD3,CH3/PC0, CH4/PD7).encoder mode, input on pd4 ch1 and PD3 channel2, works fine,display decimal
...
timer2_pwmin_config:
	...
	ori x11,x11,(3<<0)		# Set the SMS to encoder mode 3 , both chanels all edges 0b011
